...
export const LESSONS: Record<string, Lesson> = {
  ...
  WHISTLE: { title: "Crossing passed without a blast", rule: "Rule R 18", ...B("R", "R18"), lesson: "A whistle board stands before every crossing: sound one long blast there, so that anyone at the crossing hears you before they see you. The board is the reminder; the crossing is the reason." },
