...
export const LESSONS: Record<string, Lesson> = {
  ...
  "WARRANT-EARLY": { title: "Warrant cancelled early", rule: "Rule S 36", ...B("S", "S36"), lesson: "A warrant is cancelled when its train has arrived complete within your station limits and not before: the tail lamp is the proof. Until then the section is that train's, whatever the clock says." },
  "HELD-AT-HOME": { title: "Train held at the home", rule: "Rule S 38", ...B("S", "S38"), lesson: "A train you have given line clear for should find its home cleared when it reaches it. Set the route as soon as the platform is free; a train stood at the home is a driver waiting on you." },
  "BATON-LATE": { title: "Baton shown late", rule: "Rule S 40", ...B("S", "S40"), lesson: "The baton is shown at the booked time, with the starter cleared and the doors closed. Ask for line clear and pull the starter before the time, not after it; the train leaves when you show the baton, and not sooner." },
