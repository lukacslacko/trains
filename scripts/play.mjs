...
try {
  ...
  try {
    const res = which === "601" ? mod.play601() : which === "502" ? mod.play502() : which === "501" ? mod.play501() : which === "401" ? mod.play401() : which === "301" ? mod.play301() : which === "201" ? mod.play201() : mod.play101();
